...
const quizData = {
    ...
    islamic_Studies: {
        easy: [
            { q: "Which Surah of the Qur'an mentions Abu Lahab by name?", opts: ["Suratul-Ikhlas", "Suratul-Masad", "Suratul-Falaq", "Suratun-Nas"], ans: 1 },
            { q: "Suratul-Masad is also known as?", opts: ["Suratul-Lahab", "Suratul-Kafirun", "Suratul-Qadr", "Suratul-Fil"], ans: 0 },
            { q: "How many verses are in Suratul-Masad?", opts: ["4", "5", "6", "7"], ans: 1 },
            { q: "Who was Abu Lahab?", opts: ["A companion of the Prophet", "The Prophet's uncle who opposed Islam", "A king of Makkah", "A Jewish scholar"], ans: 1 },
            { q: "What does the word 'Masad' mean?", opts: ["Palm fibre rope", "Mountain", "Fire", "River"], ans: 0 },
            { q: "According to Suratul-Masad, Abu Lahab's wealth could not?", opts: ["Increase", "Save him", "Feed him", "Guide him"], ans: 1 },
            { q: "What punishment is mentioned for Abu Lahab in Suratul-Masad?", opts: ["Exile", "Imprisonment", "Poverty", "A blazing Fire"], ans: 3 },
            { q: "What will the wife of Abu Lahab carry according to the Surah?", opts: ["Gold", "Firewood", "Food", "Water"], ans: 1 },
            { q: "Around the neck of Abu Lahab's wife will be a rope of?", opts: ["Iron", "Gold", "Palm fibre", "Silver"], ans: 2 },
            { q: "The main lesson of Suratul-Masad is that?", opts: ["Wealth cannot save a person from Allah's punishment", "Trade is forbidden", "All uncles are evil", "Only the rich enter Paradise"], ans: 0 },

            { q: "Salah is the _____ pillar of Islam.", opts: ["First", "Second", "Third", "Fourth"], ans: 1 },
            { q: "How many compulsory daily prayers are Muslims required to perform?", opts: ["Three", "Four", "Five", "Six"], ans: 2 },
            { q: "Which prayer is performed before sunrise?", opts: ["Zuhr", "Asr", "Maghrib", "Fajr"], ans: 3 },
            { q: "Which prayer is performed in the middle of the day?", opts: ["Zuhr", "Isha", "Fajr", "Maghrib"], ans: 0 },
            { q: "Which prayer comes immediately after Zuhr?", opts: ["Fajr", "Asr", "Maghrib", "Isha"], ans: 1 },
            { q: "Which prayer is performed just after sunset?", opts: ["Asr", "Fajr", "Isha", "Maghrib"], ans: 3 },
            { q: "Which is the last of the five daily prayers?", opts: ["Maghrib", "Zuhr", "Isha", "Asr"], ans: 2 },
            { q: "Before performing Salah, a Muslim should be in a state of?", opts: ["Sleep", "Purity", "Trade", "Travel"], ans: 1 },
            { q: "The call to prayer is known as?", opts: ["Iqamah", "Khutbah", "Adhan", "Takbir"], ans: 2 },
            { q: "Facing the Ka'bah during prayer is called facing the?", opts: ["Qiblah", "Mihrab", "Minbar", "Hijrah"], ans: 0 },

            { q: "Hadith 6 of An-Nawawi's collection discusses?", opts: ["Good manners", "The lawful and the unlawful", "Charity", "Fasting"], ans: 1 },
            { q: "The narrator of Hadith 6 is?", opts: ["Abu Hurairah", "Ali ibn Abi Talib", "An-Nu'man ibn Bashir", "Umar ibn Al-Khattab"], ans: 2 },
            { q: "According to Hadith 6, between the lawful and unlawful are matters that are?", opts: ["Easy", "Doubtful", "Rewarding", "Popular"], ans: 1 },
            { q: "Many people do not know the ruling concerning?", opts: ["Lawful matters only", "Unlawful matters only", "Doubtful matters", "Prayer times"], ans: 2 },
            { q: "Whoever avoids doubtful matters protects his?", opts: ["Wealth only", "Religion and honour", "Family only", "Health only"], ans: 1 },
            { q: "Whoever falls into doubtful matters may eventually fall into?", opts: ["Charity", "Knowledge", "The unlawful", "Success"], ans: 2 },
            { q: "The Prophet compared doubtful matters to a shepherd grazing near a?", opts: ["River", "Market", "House", "Protected area"], ans: 3 },
            { q: "Every king has a protected area, and Allah's protected area is His?", opts: ["Creation", "Prohibitions", "Mosques", "Angels"], ans: 1 },
            { q: "According to Hadith 6, there is a piece of flesh in the body called the?", opts: ["Brain", "Liver", "Heart", "Kidney"], ans: 2 },
            { q: "If the heart is sound, the whole body will be?", opts: ["Weak", "Sound", "Tired", "Hungry"], ans: 1 }
        ],

        medium: [
            { q: "Which Surah of the Qur'an was revealed to comfort the Prophet ﷺ after he was called 'abtar'?", opts: ["Sooratul-Ikhlas", "Sooratul-Kawthar", "Sooratul-Falaq", "Sooratun-Nas"], ans: 1 },
            { q: "The word 'abtar' means?", opts: ["Blessed", "Victorious", "Cut off", "Forgiven"], ans: 2 },
            { q: "Sooratul-Kawthar is the _____ chapter of the Qur'an.", opts: ["107th", "108th", "109th", "110th"], ans: 1 },
            { q: "According to many scholars, Al-Kawthar includes all the following EXCEPT?", opts: ["Prophethood", "The Qur'an", "A river in Paradise", "Kingship over Makkah"], ans: 3 },
            { q: "Which Hadith collection reports the Prophet's statement that Al-Kawthar is a river in Paradise?", opts: ["Sahih al-Bukhari", "Sunan Abi Dawud", "Jami' at-Tirmidhi", "Sunan Ibn Majah"], ans: 0 },
            { q: "The command 'So pray to your Lord and sacrifice' teaches Muslims to show gratitude through?", opts: ["Trade and travel", "Worship and obedience", "Debate and argument", "Wealth and status"], ans: 1 },
            { q: "According to Sooratul-Kawthar, who is truly cut off?", opts: ["The Prophet ﷺ", "The believers", "The enemy of the Prophet ﷺ", "The poor"], ans: 2 },
            { q: "One major lesson from Sooratul-Kawthar is that true honour comes from?", opts: ["Wealth", "Family lineage", "People's praise", "Allah"], ans: 3 },

            { q: "Belief in the revealed books is part of belief in the?", opts: ["Pillars of Ihsan", "Articles of Iman", "Conditions of Salah", "Types of Zakah"], ans: 1 },
            { q: "The Arabic term for the Books of Allah is?", opts: ["Kutubullah", "Malaikah", "Suhuf", "Risalah"], ans: 0 },
            { q: "Which verse states that believers believe in Allah, His angels, His books and His messengers?", opts: ["Al-Ma'idah 5:48", "Al-Baqarah 2:285", "Al-Hijr 15:9", "An-Nisa 4:163"], ans: 1 },
            { q: "The Tawrah was revealed to Prophet?", opts: ["Isa (AS)", "Muhammad ﷺ", "Musa (AS)", "Dawud (AS)"], ans: 2 },
            { q: "The Zabur was revealed to Prophet?", opts: ["Musa (AS)", "Isa (AS)", "Nuh (AS)", "Dawud (AS)"], ans: 3 },
            { q: "The Injil was revealed to Prophet?", opts: ["Isa (AS)", "Musa (AS)", "Dawud (AS)", "Ibrahim (AS)"], ans: 0 },
            { q: "According to Surah Al-Ma'idah 5:46, the Injil contained?", opts: ["Guidance and light", "Only laws", "Stories alone", "Scientific discoveries"], ans: 0 },
            { q: "Which revealed book is described as the final and most complete revelation?", opts: ["Tawrah", "Qur'an", "Injil", "Zabur"], ans: 1 },
            { q: "Allah promises to preserve which book from corruption?", opts: ["Tawrah", "Zabur", "Qur'an", "Injil"], ans: 2 },
            { q: "The verse 'Indeed, it is We who sent down the Qur'an, and indeed, We will be its guardian' is found in?", opts: ["Al-Baqarah 2:285", "Al-Ma'idah 5:44", "An-Nisa 4:163", "Al-Hijr 15:9"], ans: 3 },
            { q: "The Qur'an acts as a guardian over previous scriptures because it?", opts: ["Replaces all prophets", "Confirms and corrects alterations", "Cancels belief in earlier books", "Was revealed first"], ans: 1 },
            { q: "According to the notes, the core message of all revealed books was to?", opts: ["Establish kingdoms", "Worship Allah alone and live righteously", "Promote trade", "Teach medicine"], ans: 1 },
            { q: "The Hadith 'The best of you are those who learn the Qur'an and teach it' was reported by?", opts: ["Sahih al-Bukhari", "Muslim", "At-Tirmidhi", "Abu Dawud"], ans: 0 },

            { q: "Hadith 10 begins with the statement that Allah is?", opts: ["Forgiving", "Powerful", "Pure", "Merciful"], ans: 2 },
            { q: "According to Hadith 10, Allah accepts only that which is?", opts: ["Popular", "Pure", "Abundant", "Difficult"], ans: 1 },
            { q: "The man mentioned in Hadith 10 was in a state where du'a is usually accepted because he was?", opts: ["Sleeping", "Trading", "Traveling", "Teaching"], ans: 2 },
            { q: "Which of the following was NOT mentioned as unlawful in Hadith 10?", opts: ["His food", "His drink", "His clothing", "His house"], ans: 3 },
            { q: "The main reason the man's supplication was not accepted was that?", opts: ["He traveled too far", "He raised his hands", "His lifestyle was based on unlawful things", "He prayed at night"], ans: 2 },
            { q: "Which Qur'anic verse supports the lesson of lawful consumption mentioned in Hadith 10?", opts: ["Al-Baqarah 2:168", "Al-Hijr 15:9", "An-Nisa 4:163", "Al-Ma'idah 5:48"], ans: 0 },
            { q: "Hadith 11 instructs Muslims to?", opts: ["Seek wealth", "Leave what causes doubt for what does not cause doubt", "Avoid all business", "Travel frequently"], ans: 1 },
            { q: "According to Hadith 11, actions in Islam can generally be divided into halal, haram and?", opts: ["Recommended", "Disliked", "Doubtful", "Traditional"], ans: 2 },
            { q: "When Hadith 10 and Hadith 11 are studied together, they teach Muslims to be?", opts: ["Rich and famous", "Strong and wealthy", "Clean in earnings and cautious in decisions", "Leaders of nations"], ans: 2 }
        ],
