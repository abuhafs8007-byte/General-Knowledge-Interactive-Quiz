...
const quizData = {
    ...
    basic_Science: {
        ...
        medium: [
            { q: "Pollination is the transfer of pollen grains from the?", opts: ["Ovary to stigma", "Petal to sepal", "Anther to stigma", "Root to stem"], ans: 2 },
            { q: "Which of the following agents can carry out pollination?", opts: ["Wind", "Soil", "Rocks", "Roots"], ans: 0 },
            { q: "A new plant growing from a stem cutting is an example of?", opts: ["Asexual reproduction", "Sexual reproduction", "Pollination", "Seed dispersal"], ans: 0 },
            { q: "Which of these plants can reproduce through stem cuttings?", opts: ["Cassava", "Rice", "Maize", "Beans"], ans: 0 },
            { q: "The process by which a seed begins to grow is called?", opts: ["Pollination", "Germination", "Dispersal", "Fertilization"], ans: 1 },
            { q: "Which part of a flower receives pollen grains?", opts: ["Stigma", "Anther", "Ovary", "Sepal"], ans: 0 },

            { q: "A magnet attracts materials made of?", opts: ["Iron", "Wood", "Plastic", "Rubber"], ans: 0 },
            { q: "The two ends of a magnet are called?", opts: ["Sides", "Faces", "Poles", "Edges"], ans: 2 },
            { q: "Like poles of a magnet?", opts: ["Attract", "Repel", "Join together", "Disappear"], ans: 1 },
            { q: "Unlike poles of a magnet?", opts: ["Repel", "Break apart", "Lose strength", "Attract"], ans: 3 },
            { q: "Which of these objects can be picked up by a magnet?", opts: ["Steel nail", "Paper", "Glass", "Wood"], ans: 0 },
            { q: "What happens when two north poles are brought together?", opts: ["They attract", "They melt", "They repel", "They stick permanently"], ans: 2 },
            { q: "Which of the following is not attracted by a magnet?", opts: ["Iron pin", "Steel spoon", "Copper wire", "Nail"], ans: 2 },
            { q: "A magnet has how many poles?", opts: ["One", "Two", "Three", "Four"], ans: 1 },

            { q: "Sound is a form of?", opts: ["Energy", "Matter", "Water", "Air"], ans: 0 },
            { q: "Sound is produced by?", opts: ["Freezing", "Vibration", "Melting", "Evaporation"], ans: 1 },
            { q: "Which of these can produce sound?", opts: ["A vibrating drum", "A stone", "A bottle cap", "A leaf"], ans: 0 },
            { q: "Sound travels fastest through?", opts: ["Air", "Water", "Solids", "Vacuum"], ans: 2 },
            { q: "The loudness of sound depends mainly on its?", opts: ["Amplitude", "Colour", "Weight", "Shape"], ans: 0 },
            { q: "Which organ helps humans hear sound?", opts: ["Eye", "Ear", "Nose", "Skin"], ans: 1 },
            { q: "An unwanted sound is called?", opts: ["Music", "Echo", "Noise", "Tone"], ans: 2 },
            { q: "Sound cannot travel through a?", opts: ["Solid", "Liquid", "Gas", "Vacuum"], ans: 3 },
            { q: "An echo is caused by the?", opts: ["Reflection of sound", "Absorption of sound", "Production of sound", "Loss of sound"], ans: 0 },

            { q: "Thermal energy is another name for?", opts: ["Heat energy", "Light energy", "Sound energy", "Electrical energy"], ans: 0 },
            { q: "Heat always flows from a?", opts: ["Cold object to hot object", "Hot object to cold object", "Large object to small object", "Heavy object to light object"], ans: 1 },
            { q: "Which of these is a source of heat energy?", opts: ["The Sun", "The Moon", "A mirror", "A stone"], ans: 0 },
            { q: "Which instrument is used to measure temperature?", opts: ["Barometer", "Thermometer", "Ammeter", "Compass"], ans: 1 },
            { q: "Heat transfer through direct contact is called?", opts: ["Radiation", "Convection", "Conduction", "Reflection"], ans: 2 },
            { q: "Which material is a good conductor of heat?", opts: ["Wood", "Plastic", "Copper", "Rubber"], ans: 2 },
            { q: "The transfer of heat by movement of liquids or gases is called?", opts: ["Conduction", "Convection", "Reflection", "Refraction"], ans: 1 },
        ],
