...
{ q: "Humans are classified as mammals because they?", opts: ["Lay eggs", "Have hair and feed young with milk", "Live in water", "Have wings"], ans: 1 },
            ...
            { q: "Which organ helps remove excess water and salt?", opts: ["Skin", "Brain", "Heart", "Bone"], ans: 0 }
        ],
    ...
    islamic_Studies: {
        ...
        medium: [
            ...
            { q: "Who is the last prophet of Allah?", opts: ["Isa (AS)", "Musa (AS)", "Muhammad ﷺ", "Ibrahim (AS)"], ans: 2 },
            { q: "Prophets are known for their?", opts: ["Wealth", "Truthfulness", "Strength", "Speed"], ans: 1 },
            { q: "The Prophet ﷺ fought battles mainly to?", opts: ["Gain wealth", "Defend Islam", "Show power", "Travel"], ans: 1 },
            { q: "Why did the Muslims face difficulty at Uhud?", opts: ["Lack of food", "Disobedience of some archers", "Bad weather", "Lack of water"], ans: 1 },
            { q: "Who were the enemies in many early battles?", opts: ["Romans", "Quraysh of Makkah", "Persians", "Egyptians"], ans: 1 },
            { q: "How many daily obligatory prayers are there?", opts: ["3", "4", "5", "6"], ans: 2 },
            { q: "Which prayer is offered at dawn?", opts: ["Zuhr", "Asr", "Fajr", "Maghrib"], ans: 2 },
            { q: "Which prayer comes after sunset?", opts: ["Fajr", "Zuhr", "Maghrib", "Asr"], ans: 2 },
            { q: "Which prayer is performed at night?", opts: ["Asr", "Maghrib", "Isha", "Fajr"], ans: 2 },
            { q: "What is the Conquest of Makkah?", opts: ["A trade journey", "Peaceful takeover of Makkah", "A farming event", "A festival"], ans: 1 },
            { q: "In which year did the Conquest of Makkah occur?", opts: ["5 AH", "8 AH", "10 AH", "12 AH"], ans: 1 },
            { q: "How did the Prophet ﷺ enter Makkah during the conquest?", opts: ["With violence", "Secretly", "Peacefully", "At night"], ans: 2 },
            { q: "What did the Prophet ﷺ do to the idols in the Kaaba?", opts: ["Sold them", "Kept them", "Destroyed them", "Painted them"], ans: 2 },
            { q: "What was the reaction of the Prophet ﷺ to the people of Makkah?", opts: ["Punished all", "Forgave them", "Ignored them", "Exiled them"], ans: 1 },
            { q: "Belief in prophets requires us to?", opts: ["Reject them", "Respect and follow them", "Ignore them", "Argue with them"], ans: 1 },
            { q: "Which prophet built the Kaaba?", opts: ["Musa (AS)", "Ibrahim (AS)", "Isa (AS)", "Nuh (AS)"], ans: 1 },
            { q: "Why were prophets chosen by Allah?", opts: ["For wealth", "For guidance of people", "For war", "For farming"], ans: 1 },
