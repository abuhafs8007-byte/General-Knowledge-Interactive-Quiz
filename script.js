...
const quizData = {
    ...
    basic_Science: {
        easy: [
            { q: "What is energy?", opts: ["The ability to do work", "A type of force", "A machine", "A source of water"], ans: 0 },
            { q: "Which of the following is a renewable source of energy?", opts: ["Coal", "Solar energy", "Petroleum", "Natural gas"], ans: 1 },
            { q: "A non-renewable source of energy can be?", opts: ["Replaced quickly", "Used forever", "Exhausted after long use", "Produced daily"], ans: 2 },
            { q: "Which of these is obtained from the sun?", opts: ["Wind energy", "Hydroelectric energy", "Geothermal energy", "Solar energy"], ans: 3 },
            { q: "Which of the following is a fossil fuel?", opts: ["Coal", "Sunlight", "Wind", "Water"], ans: 0 },
            { q: "Hydroelectric power is generated from?", opts: ["Flowing water", "Coal", "Petroleum", "Wood"], ans: 0 },
            { q: "Which energy source is least likely to cause pollution?", opts: ["Solar energy", "Diesel", "Coal", "Kerosene"], ans: 0 },
            { q: "Petroleum is classified as a?", opts: ["Renewable resource", "Non-renewable resource", "Natural force", "Machine"], ans: 1 },
            { q: "Windmills are used to convert wind into?", opts: ["Electrical energy", "Heat energy", "Chemical energy", "Sound energy"], ans: 0 },
            { q: "Which of these is NOT a renewable energy source?", opts: ["Sunlight", "Wind", "Coal", "Water"], ans: 2 },
            { q: "Why should non-renewable resources be conserved?", opts: ["They are unlimited", "They are expensive to transport", "They can be exhausted", "They produce oxygen"], ans: 2 },
            { q: "Firewood is considered renewable because?", opts: ["It can be replaced by planting trees", "It lasts forever", "It is found underground", "It produces electricity"], ans: 0 },
            { q: "The energy stored in food is known as?", opts: ["Heat energy", "Chemical energy", "Light energy", "Nuclear energy"], ans: 1 },
            { q: "Which of these can be used to generate electricity?", opts: ["Wind", "Coal", "Water", "All of the above"], ans: 3 },
            { q: "The main advantage of renewable energy is that it is?", opts: ["Limited", "Polluting", "Naturally replenished", "Expensive"], ans: 2 },

            { q: "Force is a?", opts: ["Push or pull", "Type of energy", "Machine", "Material"], ans: 0 },
            { q: "Which of these actions involves a force?", opts: ["Pushing a cart", "Sleeping", "Reading", "Watching television"], ans: 0 },
            { q: "The SI unit of force is?", opts: ["Joule", "Watt", "Newton", "Volt"], ans: 2 },
            { q: "Who discovered the laws of motion?", opts: ["Albert Einstein", "Isaac Newton", "Thomas Edison", "Michael Faraday"], ans: 1 },
            { q: "A force can change the?", opts: ["Colour of an object", "Shape of an object", "Temperature only", "Mass of an object"], ans: 1 },
            { q: "Which force pulls objects toward the Earth?", opts: ["Magnetic force", "Frictional force", "Gravitational force", "Applied force"], ans: 2 },
            { q: "Friction is a force that?", opts: ["Increases speed", "Opposes motion", "Creates light", "Produces electricity"], ans: 1 },
            { q: "When you kick a football, the force causes the ball to?", opts: ["Disappear", "Grow bigger", "Change colour", "Move"], ans: 3 },
            { q: "Which of these is an example of a pull?", opts: ["Closing a drawer", "Pushing a wheelbarrow", "Kicking a ball", "Throwing a stone"], ans: 0 },
            { q: "A force can make a moving object?", opts: ["Stop", "Multiply", "Melt", "Float"], ans: 0 },
            { q: "Magnetic force acts between?", opts: ["Magnets and magnetic materials", "Water and sand", "Plants and animals", "Light and heat"], ans: 0 },
            { q: "Which of the following is NOT a force?", opts: ["Gravity", "Friction", "Heat", "Magnetism"], ans: 2 },
            { q: "The force that resists the movement of surfaces is?", opts: ["Gravity", "Friction", "Magnetism", "Tension"], ans: 1 },
            { q: "Stretching a rubber band changes its?", opts: ["Colour", "Shape", "Mass", "Temperature"], ans: 1 },
            { q: "A force may change the direction of a moving object. Which action best shows this?", opts: ["Turning a moving bicycle", "Reading a book", "Drinking water", "Sleeping"], ans: 0 }
        ]
        ,
